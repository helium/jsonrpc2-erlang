    ...
    try
        ...
        BinResp =
            try
                ...
                throw:{transport_error, TransportError} when is_binary(TransportError) ->
        ...
        JsonResp =
            try
                ...
                _:_ -> throw({jsonrpc2_client, invalid_json})
            end,

        %% parse_response can fail by throwing invalid_jsonrpc_response
        RepliesById =
            try
                parse_response(JsonResp)
            catch
        ...
        throw:{jsonrpc2_client, ErrorData} ->
